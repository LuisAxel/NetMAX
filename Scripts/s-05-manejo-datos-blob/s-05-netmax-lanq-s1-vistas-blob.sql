...
--@Descripción: Definición de vistas con columnas BLOB para lanq_s1
--
...
create or replace view ARCHIVO_PROGRAMA as
    select num_archivo,programa_id, get_remote_archivo_f1_by_id(num_archivo,programa_id) as archivo,

...
--@Descripción: Crea sinonimos de lanq_s1

Prompt Fragmentos de usuario...

create or replace synonym usuario_f1 for usuario_f1_lanq_s1;
...
create or replace synonym usuario_f4 for usuario_f4_lanq_s1;
...
create or replace synonym programa_f2 for programa_f2_lanq_s1;
...
create or replace synonym documental_f2 for documental_f2_lanq_s1;
...
create or replace synonym pelicula_f2 for pelicula_f2_lanq_s1;
...
create or replace synonym serie_f2 for serie_f2_lanq_s1;
...
create or replace synonym archivo_programa_f2 for archivo_programa_f2_lanq_s1;
...
create or replace synonym playlist_f3 for playlist_f3_lanq_s1;
...
create or replace synonym tipo_cuenta_r1 for tipo_cuenta_r_lanq_s1;
...
create or replace synonym pais_r1 for pais_r_lanq_s1;
...
create or replace synonym tipo_serie_r1 for tipo_serie_r_lanq_s1;

...
--@Descripción: Crea sinonimos de lanq_s2

Prompt Fragmentos de usuario...

create or replace synonym usuario_f1 for usuario_f1_lanq_s1@lanq_s1.fi.unam;
create or replace synonym usuario_f2 for usuario_f2_lanq_s2;
create or replace synonym usuario_f3 for usuario_f3_ocp_s2@ocp_s2.fi.unam;
...
create or replace synonym programa_f3 for programa_f3_lanq_s2;
...
create or replace synonym documental_f3 for documental_f3_lanq_s2;
...
create or replace synonym pelicula_f3 for pelicula_f3_lanq_s2;
...
create or replace synonym serie_f3 for serie_f3_lanq_s2;

Prompt Fragmentos de historico_status_programa...

create or replace synonym historico_status_programa_f1 for historico_status_programa_lanq_s2;

Prompt Fragmentos de archivo_programa...

create or replace synonym archivo_programa_f1 for archivo_programa_f1_ocp_s2@ocp_s2.fi.unam;
...
create or replace synonym playlist_f1 for playlist_f1_lanq_s2;
create or replace synonym playlist_f2 for playlist_f2_ocp_s2@ocp_s2.fi.unam;
...
create or replace synonym tipo_cuenta_r3 for tipo_cuenta_r_ocp_s2@ocp_s2.fi.unam;
create or replace synonym tipo_cuenta_r4 for tipo_cuenta_r_lanq_s1@lanq_s1.fi.unam;
create or replace synonym tipo_cuenta_r1 for tipo_cuenta_r_lanq_s2;

Prompt Fragmentos de pais

create or replace synonym pais_r2 for pais_r_ocp_s1@ocp_s1.fi.unam;
create or replace synonym pais_r3 for pais_r_ocp_s2@ocp_s2.fi.unam;
create or replace synonym pais_r4 for pais_r_lanq_s1@lanq_s1.fi.unam;
create or replace synonym pais_r1 for pais_r_lanq_s2;

Prompt Fragmentos de tipo_serie

create or replace synonym tipo_serie_r2 for tipo_serie_r_ocp_s1@ocp_s1.fi.unam;
create or replace synonym tipo_serie_r3 for tipo_serie_r_ocp_s2@ocp_s2.fi.unam;
create or replace synonym tipo_serie_r4 for tipo_serie_r_lanq_s1@lanq_s1.fi.unam;
create or replace synonym tipo_serie_r1 for tipo_serie_r_lanq_s2;

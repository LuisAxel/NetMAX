...
--@Descripción: Crea sinonimos de ocp_s1
...
create or replace synonym usuario_f5 for usuario_f5_ocp_s1;

Prompt Fragmentos de programa...

create or replace synonym programa_f1 for programa_f1_ocp_s1;
...
create or replace synonym documental_f1 for documental_f1_ocp_s1;
...
create or replace synonym pelicula_f1 for pelicula_f1_ocp_s1;
...
create or replace synonym serie_f1 for serie_f1_ocp_s1;
...
create or replace synonym playlist_f4 for playlist_f4_ocp_s1;

Prompt Fragmentos de tipo_cuenta

create or replace synonym tipo_cuenta_r1 for tipo_cuenta_r_ocp_s1;
create or replace synonym tipo_cuenta_r2 for tipo_cuenta_r_ocp_s2@ocp_s2.fi.unam;
...
create or replace synonym pais_r1 for pais_r_ocp_s1;
create or replace synonym pais_r2 for pais_r_ocp_s2@ocp_s2.fi.unam;
...
create or replace synonym tipo_serie_r1 for tipo_serie_r_ocp_s1;
create or replace synonym tipo_serie_r2 for tipo_serie_r_ocp_s2@ocp_s2.fi.unam;
